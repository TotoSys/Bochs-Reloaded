...
#ifndef BX_ITANIUM_CPUID_DEFINITIONS_H
#define BX_ITANIUM_CPUID_DEFINITIONS_H

#if BX_SUPPORT_X86_64 && BX_SUPPORT_IA64

#include "cpu/cpuid.h"

class itanium_t : public bx_cpuid_t {
public:
  itanium_t(BX_CPU_C *cpu);
  virtual ~itanium_t() {}

  // return CPU name
  virtual const char *get_name(void) const { return "itanium"; }
...
extern bx_cpuid_t *create_itanium_cpuid(BX_CPU_C *cpu);

#endif // BX_SUPPORT_X86_64 && BX_SUPPORT_IA64

#endif // BX_ITANIUM_CPUID_DEFINITIONS_H